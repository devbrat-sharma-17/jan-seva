...
export function ReportHeader({ currentStep, hasPhotos, onBack }: ReportHeaderProps) {
  ...
  return (
    <>
      <header className="report-header" aria-label={t('report.header.title')}>
        <button
          type="button"
        ...
        <h1 className="report-header__title">{t('report.header.title')}</h1>
