...
export const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'report.photo.cameraOnly': 'Photos are taken here in the app, so the repair team knows the issue is real and current.',
    'report.photo.checking': 'Checking photo…',
  ...
  hi: {
    ...
    'report.photo.cameraOnly': 'फ़ोटो ऐप में ही ली जाती है, ताकि मरम्मत टीम को पता रहे कि समस्या असली और मौजूदा है।',
    'report.photo.checking': 'फ़ोटो जाँची जा रही है…',
